...
public class Fantasy_EventModel {
    ...
    public Fantasy_EventModel(String eventName, double eventID, String eventDescription, double eventChoiceID1, String eventChoice1, double eventChoiceID2, String eventChoice2, double eventChoiceID3, String eventChoice3){
